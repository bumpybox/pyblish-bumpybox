...
# List of DNXHD settings;
# http://www.thinkboxsoftware.com/draft-change-encoding-recipe/
encoder = None
if audio:
    encoder = Draft.VideoEncoder(outBase + outExt, params['fps'], outWidth,
                                 outHeight, codec="DNXHD", audioFilename=audio,
                                 kbitRate=36000)
else:
    encoder = Draft.VideoEncoder(outBase + outExt, params['fps'], outWidth,
                                 outHeight, codec="DNXHD", kbitRate=36000)
