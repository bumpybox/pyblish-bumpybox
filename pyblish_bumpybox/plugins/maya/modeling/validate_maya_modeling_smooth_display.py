...
class RepairMayaModelingSmoothDisplay(pyblish.api.Action):
...
class ValidateMayaModelingSmoothDisplay(pyblish.api.InstancePlugin):
    ...
    actions = [RepairMayaModelingSmoothDisplay]
